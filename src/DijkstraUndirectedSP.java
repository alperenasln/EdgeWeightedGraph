...
public class DijkstraUndirectedSP {
	...
	// This is the method to find shortest path and calculate the total.
	public void findSP(EdgeWeightedGraph G, int source, int destination) {
		DijkstraUndirectedSP sp = new DijkstraUndirectedSP(G, source);
		try {
			
			total = total + sp.distTo(destination);
